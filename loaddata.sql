...
INSERT INTO Posts VALUES (null, 1, 2, 'The Best Places to Visit in Europe', '2023-04-23', 'Europe is full of beautiful destinations that are waiting to be explored. In this post, we will discuss some of the best places to visit in Europe, including Paris, Rome, and Barcelona.');
INSERT INTO Posts VALUES (null, 2, 3, 'My Morning Routine', '2023-04-22', 'I wake up early every morning and start my day with a cup of coffee and a quick workout. Then, I spend some time meditating and journaling before starting work. Here is a more detailed breakdown of my morning routine.');
INSERT INTO Posts VALUES (null, 3, 1, 'How to Stay Productive When Working from Home', '2023-04-21', 'Working from home can be challenging, especially if you have trouble staying focused. In this post, we will share some tips and tricks for staying productive when working from home, including setting up a dedicated workspace and using time-blocking techniques.');
